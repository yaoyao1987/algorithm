...
3. [剑指 Offer 10- I. 斐波那契数列](https://leetcode-cn.com/problems/fei-bo-na-qi-shu-lie-lcof/)
...
1. [319. 灯泡开关](https://leetcode-cn.com/problems/bulb-switcher/)
...
3. [680. 验证回文字符串 Ⅱ](https://leetcode-cn.com/problems/valid-palindrome-ii/)
4. [x 的平方根](https://leetcode-cn.com/problems/sqrtx/)

## 并查集

1. [947. 移除最多的同行或同列石头](https://leetcode-cn.com/problems/most-stones-removed-with-same-row-or-column/)
2. [990. 等式方程的可满足性](https://leetcode-cn.com/problems/satisfiability-of-equality-equations/)
